...
{
    UIViewController *mainVC = [[INSlideViewManager shareInstance] slideViewController];
    [AppNavigator openMainNavControllerWithRoot:mainVC];

//    AppDelegate *appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
//    GPTabBarController *tabbar = [[GPTabBarController alloc]init];
//    UINavigationController *rootNavi = [[UINavigationController alloc]initWithRootViewController:tabbar];
...
{
//    QTLoginViewController *viewController = [[QTLoginViewController alloc] init];
